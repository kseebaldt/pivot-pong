...
describe TwilightSaga do
  ...
  describe "#eligible" do
    ...
    it "should be eligible if you Log a match before 6pm PST" do
      create(:match, winner: me, loser: you, occured_at: (Date.today.beginning_of_day + 19.hours))
    ...
    it "should not be eligible if you Log a match after 9am PST" do
      create(:match, winner: me, loser: you, occured_at: (Date.today.beginning_of_day + 17.hours))
