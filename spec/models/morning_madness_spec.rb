...
describe MorningMadness do
  ...
  describe "#eligible" do
    ...
    it "should be eligible if you Log a match before 9am PST" do
      create(:match, winner: me, loser: you, occurred_at: (Time.current.beginning_of_day + 8.hours))
    ...
    it "should not be eligible if you Log a match after 9am PST" do
      create(:match, winner: me, loser: you, occurred_at: (Time.current.beginning_of_day + 10.hours))
