...
describe MatchesController do
  ...
  describe "GET #index" do
    ...
    let!(:newer_match) { create(:match, winner: me, loser: you, occured_at: occured_at) }
    let!(:older_match) { create(:match, winner: you, loser: me, occured_at: occured_at - 1.day) }
  ...
  describe "GET #show" do
    ...
    let(:me) { Player.create(name: "me") }
    let(:you) { Player.create(name: "you") }
    let!(:match) { create(:match, winner: me, loser: you, occured_at: occured_at) }
  ...
  describe "POST #create" do
    let(:match_params) { {winner_name: "taeyang", loser_name: "se7en", match: { occured_at: '2014-03-22' } } }
  ...
  describe "GET #rankings" do
    ...
    it "returns the correctly ranked players" do
      ...
      MatchObserver.after_save create(:match, winner: you, loser: me, occured_at: occured_at - 1.day)
      MatchObserver.after_save create(:match, winner: me.reload, loser: you.reload, occured_at: occured_at)
